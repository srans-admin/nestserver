...
public interface HostelRepository extends JpaRepository<Hostel, Long> {
	...
	/*
	 * @Query(value="SELECT admin_id FROM HOSTEL WHERE id=?1",nativeQuery=true)
	...
	public String hostelName(String hostel_name);
	...
	public Hostel findByadminId(long adminId);
