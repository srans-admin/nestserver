...
public class SransUserController {
	...
	public ResponseEntity<SransUser> updateUser(@PathVariable(value = "Id") Long SransUserId,
		...
		sransUser.setContactNumber(sransUser.getContactNumber());
		sransUser.setFatherName(sransUser.getFatherName());
		sransUser.setFatherphoneNumber(sransUser.getFatherphoneNumber());
		sransUser.setMotherName(sransUser.getMotherName());
		sransUser.setMotherphoneNumber(sransUser.getMotherphoneNumber());
		sransUser.setBloodGroup(sransUser.getBloodGroup());
		sransUser.setEmergencyContactNumber(sransUser.getEmergencyContactNumber());
		sransUser.setNameOfTheEmployer(sransUser.getNameOfTheEmployer());
		sransUser.setOfficeAddress(sransUser.getOfficeAddress());
		sransUser.setTelephoneNumber(sransUser.getTelephoneNumber());
