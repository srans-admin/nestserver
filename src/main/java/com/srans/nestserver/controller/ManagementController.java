...
public class ManagementController {
	...
	public ResponseEntity<Management> getManagementById(@PathVariable(value = "id") Long managementId)
		...
		Management management = managementRepository.findById(managementId).orElseThrow(
				() -> new ResourceNotFoundException("management not found for this id :: " + managementId));
